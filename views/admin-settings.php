...
<div class="wrap">
	...
	<div class="cm-forge-preview">
		...
		<textarea id="cm-forge-preview-editor" class="cm-forge-preview-textarea" data-mode="javascript">
			<?php
			// phpcs:ignore WordPress.WP.AlternativeFunctions.file_get_contents_file_get_contents
			echo esc_textarea( file_get_contents( CM_FORGE_PLUGIN_DIR . 'tests/mocks/example.js' ) );
			?>
		</textarea>
	</div>
</div>
